...
import fr.ans.psc.delegate.PsRefApiDelegateImpl;
...
@DirtiesContext
@ActiveProfiles("test")
public class PsRefOperationTest {
    ...
    @BeforeEach
    public void setUp() {
        Logger logger = (Logger) LoggerFactory.getLogger(PsRefApiDelegateImpl.class);
    ...
    @Test
    @DisplayName(value = "should get PsRef by nationalIdRef")
    public void getPsRefById(){
